---
title: "Peut-on se sauver par la loi naturelle seule (hors ignorance invincible) ?"
question: "Un bouddhiste qui respecte la loi morale naturelle, mais qui a entendu parler du christianisme et ne s'y est pas converti, peut-il être sauvé ? (hors hypothèse d'ignorance invincible)"
...
related_documents:
  - "1431_florence"
  - "1863-08-10_quanto-conficiamur_enc"
  - "1928-01-06_mortalium-animos_enc"
  - "1943-06-29_mystici-corporis-christi_enc"
  - "1964-11-21_lumen-gentium_const"
  - "1965-12-07_ad-gentes_decret"
  - "1965-12-07_gaudium-et-spes_const"
  - "1965-10-28_nostra-aetate_decl"
  - "2000-08-06_dominus-iesus_document"
  - "2007-11-30_spe-salvi_encyclique"
  - "2013-06-29_lumen-fidei_encyclique"
  - "2018-02-22_placuit-deo_document"
  - "2020-10-03_fratelli-tutti_encyclique"
  - "2024-04-02_dignitas-infinita_document"
  - "2025-11-03_unica-croce-salvezza_document"
  - "2025-11-04_mater-populi-fidelis_document"
  - "1566_catechismus-romanus_01-pars-prima"
  - "1908_catechismo-pio-x_03-parte-1-credo"
  - "1598_dottrina-cristiana-breve_01-prima-classe-fine-cristiano-credo"
related_themes:
...
>
> — *Pie IX,* Quanto Conficiamur Moerore, *10 août 1863* (source : `1863-08-10_quanto-conficiamur_enc.it.md`, l. 19)

Le pape énonce donc **quatre conditions cumulatives** pour les non-chrétiens :

1. être dans une ignorance **invincible** de la religion catholique ;
2. observer **avec soin** la loi naturelle et ses préceptes ;
3. être **disposé à obéir à Dieu** ;
4. mener une vie **honnête et droite**.
...
>
> — *Pie XI,* Mortalium Animos, *6 janvier 1928* (source : `1928-01-06_mortalium-animos_enc.la.md`, l. 23)
...
>
> — *Pie XII,* Mystici Corporis Christi, *29 juin 1943* (source : `1943-06-29_mystici-corporis-christi_enc.la.md`, l. 63)
...
>
> — *Catéchisme du Concile de Trente, Première partie, chap. I, § I* (source : `1566_catechismus-romanus_01-pars-prima.la.md`, l. 7)
...
>
> — *Catéchisme du Concile de Trente, IIᵉ partie, chap. de l'Eucharistie, § L* (source : `1566_catechismus-romanus_02-pars-secunda.la.md`, l. 809)
...
>
> — *Catéchisme du Concile de Trente, IIᵉ partie, chap. du baptême, § XXXI* (source : `1566_catechismus-romanus_02-pars-secunda.la.md`, l. 297)
...
>
> — *Bellarmin,* Dottrina cristiana breve, *Première Classe, Credo, dernier article* (source : `1598_dottrina-cristiana-breve_01-prima-classe-fine-cristiano-credo.it.md`, l. 145)
...
>
> — *Catéchisme de saint Pie X, Q. 169* (source : `1908_catechismo-pio-x_03-parte-1-credo.it.md`, l. 710-712)
...
>
> — *Catéchisme de saint Pie X, Q. 566* (source : `1908_catechismo-pio-x_06-parte-4-sacramenti.it.md`, l. 237-239)
...
>
> — *Catéchisme de saint Pie X, Q. 864* (source : `1908_catechismo-pio-x_07-parte-5-virtu.it.md`, l. 67-69)
...
>
> — *Vatican II,* Lumen Gentium, *n. 14* (source : `1964-11-21_lumen-gentium_const.la.md`, l. 109)
...
>
> — *Vatican II,* Lumen Gentium, *n. 16* (source : `1964-11-21_lumen-gentium_const.la.md`, l. 117)
...
>
> — *Vatican II,* Ad Gentes, *n. 7* (source : `1965-12-07_ad-gentes_decret.la.md`, l. 65)
...
>
> — *Vatican II,* Gaudium et Spes, *n. 22* (source : `1965-12-07_gaudium-et-spes_const.la.md`, l. 228)
...
>
> — *Vatican II,* Nostra Aetate, *n. 2* (source : `1965-10-28_nostra-aetate_decl.la.md`, l. 32)
...
>
> — *CEC, §161* (source : `1997-08-15_ccc-lt_p1s1c3a1_lt.la.md`, l. 91)
...
>
> — *CEC, §846* (source : `1997-08-15_ccc-lt_p123a9p3_lt.la.md`, l. 161)
...
>
> — *CEC, §848* (source : `1997-08-15_ccc-lt_p123a9p3_lt.la.md`, l. 169)
...
>
> — *CEC, §1257* (source : `1997-08-15_ccc-lt_p2s2c1a1_lt.la.md`, l. 159)
...
>
> — *CEC, §1792* (source : `1997-08-15_ccc-lt_p3s1c1a6_lt.la.md`, l. 76)
...
>
> — *CDF,* Dominus Iesus, *n. 20, 6 août 2000* (source : `2000-08-06_dominus-iesus_document.la.md`, l. 141)
...
>
> — *CDF,* Dominus Iesus, *n. 22, 2000* (source : `2000-08-06_dominus-iesus_document.la.md`, l. 149)
...
>
> — *CDF,* Dominus Iesus, *n. 21, 2000* (source : `2000-08-06_dominus-iesus_document.la.md`, l. 145)
...
>
> — *Benoît XVI,* Spe Salvi, *n. 27* (source : `2007-11-30_spe-salvi_encyclique.la.md`)
...
>
> — *François,* Lumen Fidei, *n. 41* (source : `2013-06-29_lumen-fidei_encyclique.it.md`)
...
>
> — *CDF,* Placuit Deo, *n. 3, 22 février 2018* (source : `2018-02-22_placuit-deo_document.it.md`)
...
>
> — *François,* Fratelli Tutti, *n. 271* (source : `2020-10-03_fratelli-tutti_encyclique.it.md`)
...
>
> — *DDF,* Dignitas Infinita, *note 34, 2 avril 2024* (source : `2024-04-02_dignitas-infinita_document.it.md`, renvoyant à CEC §§1213, 1265, 1270, 1279)
...
>
> — *DDF,* Unica Croce Salvezza, *§ III.2, 3 novembre 2025* (source : `2025-11-03_unica-croce-salvezza_document.it.md`)
...
>
> — *DDF,* Mater Populi Fidelis, *n. 27, 4 novembre 2025* (source : `2025-11-04_mater-populi-fidelis_document.it.md`)
...
1. **effacé la clause d'ignorance invincible**, parlant comme si tout non-chrétien pouvait se sauver sans condition ;
2. **remplacé la bonne foi qui cherche la vérité** par la simple honnêteté morale naturelle ;
3. **déplacé le langage** : on parle volontiers d'*estime pour les religions* sans rappeler la *grave carence objective* qu'elles représentent (*Dominus Iesus* 22) ;
4. **suspendu l'effort missionnaire** : si tous se sauvent comme ils sont, pourquoi prêcher la conversion ?
...
- **Concile de Florence — Bulle *Cantate Domino* pour les Coptes (4 février 1442)** → `/documents/1431_florence/`
- **Concile Vatican I — Constitution dogmatique *Dei Filius* (1870)** → `/documents/1869_vatican-i/`
- **Pie IX — Encyclique *Quanto Conficiamur Moerore* (10 août 1863)** → `/documents/1863-08-10_quanto-conficiamur_enc/`
- **Pie XI — Encyclique *Mortalium Animos* (6 janvier 1928)** → `/documents/1928-01-06_mortalium-animos_enc/`
- **Pie XII — Encyclique *Mystici Corporis Christi* (29 juin 1943)** → `/documents/1943-06-29_mystici-corporis-christi_enc/`
- **Catéchisme du Concile de Trente ou Catéchisme romain (1566)** → `/documents/1566_catechismus-romanus_01-pars-prima/`
- **Saint Robert Bellarmin — *Dottrina cristiana breve* (1598)** → `/documents/1598_dottrina-cristiana-breve_01-prima-classe-fine-cristiano-credo/`
- **Saint Pie X — *Catechismo della dottrina cristiana* (1908)** → `/documents/1908_catechismo-pio-x_03-parte-1-credo/`
- **Vatican II — Constitution dogmatique *Lumen Gentium* (21 novembre 1964)** → `/documents/1964-11-21_lumen-gentium_const/`
- **Vatican II — Décret *Ad Gentes* (7 décembre 1965)** → `/documents/1965-12-07_ad-gentes_decret/`
- **Vatican II — Constitution pastorale *Gaudium et Spes* (7 décembre 1965)** → `/documents/1965-12-07_gaudium-et-spes_const/`
- **Vatican II — Déclaration *Nostra Aetate* (28 octobre 1965)** → `/documents/1965-10-28_nostra-aetate_decl/`
- **Catéchisme de l'Église catholique, editio typica latina (15 août 1997)** → `/documents/1997-08-15_ccc-lt_p123a9p3_lt/`
...
- **Benoît XVI — Encyclique *Spe Salvi* (30 novembre 2007)** → `/documents/2007-11-30_spe-salvi_encyclique/`
- **François — Encyclique *Lumen Fidei* (29 juin 2013)** → `/documents/2013-06-29_lumen-fidei_encyclique/`
- **Congrégation pour la Doctrine de la Foi — Lettre *Placuit Deo* (22 février 2018)** → `/documents/2018-02-22_placuit-deo_document/`
- **François — Encyclique *Fratelli Tutti* (3 octobre 2020)** → `/documents/2020-10-03_fratelli-tutti_encyclique/`
- **Dicastère pour la Doctrine de la Foi — Déclaration *Dignitas Infinita* (2 avril 2024)** → `/documents/2024-04-02_dignitas-infinita_document/`
