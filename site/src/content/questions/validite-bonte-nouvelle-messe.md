...
question: "La nouvelle messe (Novus Ordo Missae) promulguée par Paul VI le 3 avril 1969 est-elle valide ? est-elle bonne ? est-elle l'équivalent du rite tridentin fixé par saint Pie V dans Quo Primum (1570) ? On ne traite ici que la question doctrinale du rite officiel typique en latin — les abus liturgiques individuels, les versions vernaculaires défectueuses et le cas du prêtre simulant l'intention sont exclus du périmètre."
slug: "validite-bonte-nouvelle-messe"
date: "2026-04-25"
summary: "Triple réponse. (1) Validité sacramentelle : oui, la NOM en latin selon ses rubriques officielles est valide — matière, forme essentielle (Hoc est corpus meum / Hic est calix sanguinis mei) et intention pontificale promulgatoire sont préservées. (2) Bonté : contestée. Le rite n'exprime plus avec la même force le caractère sacrificiel-propitiatoire défini par Trente (sess. XXII, can. 1, 3, 6) ; les principes posés par Pie XII dans Mediator Dei (continuité organique, refus de l'archéologisme, primat du prêtre) sont tendus par le résultat de 1969 ; et Rome elle-même a dû corriger des dérives dès Memoriale Domini (1969). (3) Équivalence avec Pie V : non. Benoît XVI affirmait en 2007 « deux usages d'un seul rite romain » (Summorum Pontificum), mais François a inversé en 2021 (« expression unique de la lex orandi », Traditionis Custodes) — conflit magistériel disciplinaire ouvert. La critique tradi (Bref examen Ottaviani-Bacci, 1969) reste doctrinalement structurée par les canons tridentins."
...
1. **Validité sacramentelle** — la NOM, célébrée en latin selon l'*editio typica* officielle, confecte-t-elle l'eucharistie ? La transsubstantiation s'opère-t-elle ?
...
(L'article 7 sera *modifié* par Rome en 1970, dans une *Institutio generalis* révisée, précisément en réponse à cette objection — preuve que la critique avait juste sur ce point précis.)
...
3. **Tension entre *Summorum Pontificum* (2007) et *Traditionis Custodes* (2021).** Sur le statut canonique du Missel tridentin, les deux pontificats successifs disent l'inverse l'un de l'autre. Ces deux énoncés sont des **actes législatifs disciplinaires** (motu proprio), non des définitions dogmatiques *ex cathedra* : ils relèvent du magistère ordinaire pontifical authentique, qui appelle obéissance religieuse mais demeure réformable. L'argument canonique de Benoît XVI conserve sa force intrinsèque : un Missel jamais juridiquement abrogé n'est pas abrogeable rétroactivement par simple changement de qualification.
...
**6. Formule synthétique finale** : *« La nouvelle messe de Paul VI, célébrée en latin selon ses rubriques officielles, est valide — la transsubstantiation s'y opère vraiment. Mais sa bonté en tant qu'expression du dogme tridentin du sacrifice propitiatoire est doctrinalement contestée, et cette contestation s'enracine dans Trente, dans Mediator Dei, dans le Bref examen critique de deux cardinaux de la Curie en 1969. Et son équivalence avec le rite tridentin reste juridiquement disputée à Rome elle-même, entre Summorum Pontificum 2007 et Traditionis Custodes 2021. La messe est valide ; le rite est blessé ; le débat reste ouvert. »*
